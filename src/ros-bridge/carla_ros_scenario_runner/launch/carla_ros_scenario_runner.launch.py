...
def generate_launch_description():
    ld = launch.LaunchDescription(
        [
            ...
            launch.actions.DeclareLaunchArgument(name="scenario_runner_path"),
            launch.actions.DeclareLaunchArgument(
                name="wait_for_ego", default_value="True"
            ),
            launch_ros.actions.Node(
                ...
                parameters=[
                    ...
                    {
                        "wait_for_ego": launch.substitutions.LaunchConfiguration(
                            "wait_for_ego"
                        )
                    },
                ],
