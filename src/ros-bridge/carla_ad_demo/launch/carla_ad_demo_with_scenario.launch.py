...
ros_topic_msg_string = "{{ 'scenarios': [{{ 'name': 'FollowLeadingVehicle', 'scenario_file': '{}'}}\
    , {{ 'name': 'PedCrash', 'scenario_file': '{}'}}] }}".format(
    os.path.join(
        get_package_share_directory("carla_ad_demo"), "config/FollowLeadingVehicle.xosc"
    ),
    ...
    ld = launch.LaunchDescription(
        [
            ...
            launch.actions.IncludeLaunchDescription(
                ...
                launch_arguments={
                    "object_definition_file": get_package_share_directory(
                        "carla_spawn_objects"
                    )
                    + "/config/objects.json",
                    "role_name": launch.substitutions.LaunchConfiguration("role_name"),
            ...
            launch.actions.IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "port": launch.substitutions.LaunchConfiguration("port"),
                    "role_name": launch.substitutions.LaunchConfiguration("role_name"),
                    "scenario_runner_path": launch.substitutions.LaunchConfiguration(
