...
def generate_test_description():
    ld = launch.LaunchDescription(
        [
            ...
            launch.actions.DeclareLaunchArgument(
                name="vehicle_filter", default_value="vehicle.tesla.model3"
            ),
            launch.actions.DeclareLaunchArgument(
            ...
            launch.actions.DeclareLaunchArgument(
                name="spawn_point", default_value="None"
            ),
            launch.actions.DeclareLaunchArgument(
                name="objects_definition_file",
                default_value=get_package_share_directory("carla_ros_bridge")
                + "/test/test_objects.json",
            ),
